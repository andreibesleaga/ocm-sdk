  ...
  },
  {
    ...
    perLanguage: {
      ...
      python: {
        ...
        example:
          'import os\nfrom ocm import Ocm\n\nclient = Ocm(\n    bearer=os.environ.get("OCM_USERNAME"),  # This is the default and can be omitted\n)\nresponse = client.comment.submit(\n    charge_point_id=0,\n    checkin_status_type_id=0,\n    comment="string",\n    comment_type_id=0,\n    rating=3,\n    related_url="string",\n    user_name="string",\n)\nprint(response.description)',
      },
      go: {
        method: 'client.Comment.Submit',
        example:
