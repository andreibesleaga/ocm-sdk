...
const EMBEDDED_METHODS: MethodEntry[] = [
  {
    ...
    "response": "{ AddressInfo?: object; Connections?: object[]; DataProvider?: object; DataProviderID?: number; DataProvidersReference?: string; DataQualityLevel?: number; DateCreated?: string; DateLastConfirmed?: string; DateLastStatusUpdate?: string; DateLastVerified?: string; DatePlanned?: string; GeneralComments?: string; ID?: number; IsRecentlyVerified?: boolean; MediaItems?: object[]; MetadataValues?: object[]; NumberOfPoints?: number; OperatorID?: number; OperatorInfo?: object; OperatorsReference?: string; ParentChargePointID?: number; StatusType?: object; StatusTypeID?: number; SubmissionStatus?: object; SubmissionStatusTypeID?: number; UsageCost?: string; UsageType?: object; UsageTypeID?: number; UserComments?: object[]; UUID?: string; }[]",
  ...
  },
  {
    ...
    "response": "{ ChargerTypes?: object[]; CheckinStatusTypes?: object[]; ConnectionTypes?: object[]; Countries?: country[]; CurrentTypes?: object[]; DataProviders?: object[]; DataTypes?: object; MetadataGroups?: string; Operators?: object[]; StatusTypes?: object[]; SubmissionStatusTypes?: object[]; UsageTypes?: object[]; UserCommentTypes?: object[]; }",
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.openchargemap.io/v3/comment \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $OCM_USERNAME\" \\\n    -d '{\n          \"chargePointID\": 0,\n          \"rating\": 3\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.openchargemap.io/v3/mediaitem \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $OCM_USERNAME\" \\\n    -d '{\n          \"chargePointID\": 1234,\n          \"imageDataBase64\": \"data:image/jpeg;base64,<BASE64_ENCODED_DATA>\"\n        }'"
      }
    }
  },
  {
