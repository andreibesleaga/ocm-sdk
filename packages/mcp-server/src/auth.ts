...
const apiKey = Array.isArray(req.headers['x-ocm-api-key']) ? req.headers['x-ocm-api-key'][0] : req.headers['x-ocm-api-key']
const apiKeyHeader = Array.isArray(req.headers['x-api-key']) ? req.headers['x-api-key'][0] : req.headers['x-api-key']
const bearer = Array.isArray(req.headers['x-ocm-username']) ? req.headers['x-ocm-username'][0] : req.headers['x-ocm-username']
